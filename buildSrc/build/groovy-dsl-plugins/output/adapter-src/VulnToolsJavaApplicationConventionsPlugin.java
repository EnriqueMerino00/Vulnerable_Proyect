...
/**
 * Precompiled vuln.tools.java-application-conventions script plugin.
 **/
public class VulnToolsJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_VulnToolsJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("vuln.tools.java-common-conventions");
            target.getPluginManager().apply("application");
            target.getPluginManager().apply("java-library");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_VulnToolsJavaApplicationConventions").asSubclass(BasicScript.class);
